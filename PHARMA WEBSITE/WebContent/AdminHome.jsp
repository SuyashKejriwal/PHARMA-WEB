      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-4 mb-0 ">
            <a href="adminlogin.jsp" class='text-gray font-normal'>Admin Home</a> <span class="mx-2 mb-0">/</span>
            ...
            <div class="col-lg-3 col-md-3">
             ...
             <a href="adminlogin.jsp" class='text-gray font-normal'>(Admin)</a>
             </div>
      ...
      <div class="row">
        ...
        <button type="button" class="btn btn-secondary btn-md dropdown-toggle px-4" id="dropdownMenuReference"
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
            <a class="dropdown-item" href="AdminHome.jsp">All</a>
            <a class="dropdown-item" href="AdminHome.jsp?medcategory=capsule">Capsule</a>
            <a class="dropdown-item" href="AdminHome.jsp?medcategory=cream">Cream</a>
            <a class="dropdown-item" href="AdminHome.jsp?medcategory=syrup">Syrup</a>
            <a class="dropdown-item" href="AdminHome.jsp?medcategory=tablet">Tablet</a>
    </div>
...
<div class="col-lg-9 col-md-9">
 ...
 int medquantity;
  ...
  for(Medicine med: lst){
	  ...
	  out.println(" <a href='ShopSingleAdmin.jsp?medid=");
	  out.println(medid);
	  out.println("'> <img src= ");	  
	  out.println(medphoto);
	  out.println("alt='Image' class='border border-dark'></a>");
	  out.println("<h3 class='text-dark'> <a href='ShopSingleAdmin.jsp?medid="+ medid+ "'>");
	  out.println(medname);
	  out.println("</a></h3>");
	  out.println("<p class='price text-center font-bold'>");
	  out.println("Rs. " + medprice);
	  out.println("</p>");
	  if(medquantity<12){
		  out.println("<p class='text-red text-right font-normal'>");
		  out.println("<a href='ShopSingleAdmin.jsp?medid="+ medid+ "' class='text-red'>");
		  out.println("Reorder Required.</a></p>");
	  }
...
function dispsearchedmed() 
{
	...
	window.open("http://localhost:8085/PHARMA_WEBSITE/AdminHome.jsp?medname="+medicinename);
}
</script>
