...
<div class="limiter">
      <div class="container-login100">
        <div class="wrap-login100">
          <form action="UserDBLogin.jsp" class="login100-form validate-form p-l-55 p-r-55 p-t-178">
            <span class="login100-form-title">
              User Login
            </span>
  
            <div class="wrap-input100 validate-input m-b-16" data-validate="Please enter username">
              <input class="input100" type="text" name="txtusername" placeholder=" User EmailId">
              <span class="focus-input100"></span>
            </div>
  
            <div class="wrap-input100 validate-input" data-validate = "Please enter password">
              <input class="input100" type="password" name="txtuserpassword" placeholder="Password">
              <span class="focus-input100"></span>
            </div>
            ...
            <div class="flex-col-c p-t-70 p-b-40">
              <div class="txt1 p-b-9 text-center font-normal">
                Donot have an account?
              </div>
                <div class="text-center ">
                  <a href="UserRegister.jsp" class="txt3 text-center font-normal">
                    Register now
                  </a>
                </div>
