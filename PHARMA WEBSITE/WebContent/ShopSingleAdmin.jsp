...
<%// this is service method for session check and then retrieving the name of medicine
     String adminname=(String)session.getAttribute("adminname");
		...
		upquantity=request.getParameter("medquantity");
		if(upquantity!=null){
			updquantity=Integer.parseInt(upquantity);
			MedicineDBHandler.ReorderQuantity(updquantity, medid);
		}
      ...
      <div class="container">
          ...
          <div class="col-md-7">
            ...
            <p class='text-info font-normal'><%=meddesc%></p>
             ...
             <p class="text-red font-normal">Only <%=medquantity %> left in stock</p>
              <div class="row mb-5">
              <div class="col-md-8">
              <h4  class="text-black">Select Reorder Quantity</h4>
              <div class="input-group mb-3" style="max-width: 300px;">
                <div class="input-group-prepend">
                  <button class="btn btn-outline-primary" type="button" onclick="minus()">&minus;</button>
                </div>
                <input type="number" class="form-control text-center" id="count" value="1" placeholder=""
              ...
              <div class="col-md-4">
                 <p><a class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary" onclick="reorder()">Reorder</a></p>     
              </div>   
        </div>
        ...
        <div class="tab-content" id="pills-tabContent">
            ...
            function reorder(){
            	...
            	quantity=quantity+<%=medquantity %>;
            	window.open("http://localhost:8085/PHARMA_WEBSITE/ShopSingleAdmin.jsp?medid="+<%=medid%> + "&medquantity="+quantity);
            }
